...
static void scan_chains(struct device *dev)
{
	unsigned nodeid;
	struct bus *link;
...
{
#if CONFIG(AGESA_LEGACY_WRAPPER)
...
static void f15_pci_domain_scan_bus(struct device *dev)
{
