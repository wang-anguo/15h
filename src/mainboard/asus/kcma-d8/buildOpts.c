 ...
 */
CONST MANUAL_BUID_SWAP_LIST ROMDATA kcma_d8_manual_swaplist[2] =
{
	{
 ...
 *
 */
CONST CPU_TO_CPU_PCB_LIMITS ROMDATA kcma_d8_cpu2cpu_limit_list[2] =
{
	{
...
CONST IO_PCB_LIMITS ROMDATA kcma_d8_io_limit_list[2] =
{
	{
		/* On the reference platform, there is only one nc chain, so socket & link are 'don't care' */
 ...
 */
CONST CPU_HT_DEEMPHASIS_LEVEL ROMDATA kcma_d8_deemphasis_list[] =
{
...
CONST AP_MTRR_SETTINGS ROMDATA kcma_d8_ap_mtrr_list[] =
{
...
#define BLDCFG_BUID_SWAP_LIST			&kcma_d8_manual_swaplist
#define BLDCFG_HTFABRIC_LIMITS_LIST		&kcma_d8_cpu2cpu_limit_list
