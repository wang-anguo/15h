 ...
 */
CONST MANUAL_BUID_SWAP_LIST ROMDATA kgpe_d16_manual_swaplist[2] =
{
	{
 ...
 *
 */
CONST CPU_TO_CPU_PCB_LIMITS ROMDATA kgpe_d16_cpu2cpu_limit_list[2] =
{
	{
...
CONST IO_PCB_LIMITS ROMDATA kgpe_d16_io_limit_list[2] =
{
	{
		/* On the reference platform, there is only one nc chain, so socket & link are 'don't care' */
 ...
 */
CONST CPU_HT_DEEMPHASIS_LEVEL ROMDATA kgpe_d16_deemphasis_list[] =
{
...
CONST AP_MTRR_SETTINGS ROMDATA kgpe_d16_ap_mtrr_list[] =
{
...
#define BLDCFG_BUID_SWAP_LIST			&kgpe_d16_manual_swaplist
#define BLDCFG_HTFABRIC_LIMITS_LIST		&kgpe_d16_cpu2cpu_limit_list
#define BLDCFG_HTCHAIN_LIMITS_LIST		&kgpe_d16_io_limit_list
#define BLDCFG_PLATFORM_DEEMPHASIS_LIST		&kgpe_d16_deemphasis_list
#define BLDCFG_AP_MTRR_SETTINGS_LIST		&kgpe_d16_ap_mtrr_list
