 ...
 */
CONST MANUAL_BUID_SWAP_LIST ROMDATA h8dgi_manual_swaplist[2] =
{
	{
 ...
 *
 */
CONST CPU_TO_CPU_PCB_LIMITS ROMDATA h8dgi_cpu2cpu_limit_list[2] =
{
	{
...
CONST IO_PCB_LIMITS ROMDATA h8dgi_io_limit_list[2] =
{
	{
		/* On the reference platform, there is only one nc chain, so socket & link are 'don't care' */
 ...
 */
CONST CPU_HT_DEEMPHASIS_LEVEL ROMDATA h8dgi_deemphasis_list[] =
{
 ...
 *
 */
CONST SYSTEM_PHYSICAL_SOCKET_MAP ROMDATA h8dgi_socket_map[] =
{
#define HT_SOCKET0	0
#define HT_SOCKET1	1
#define HT_SOCKET2	2
...
CONST AP_MTRR_SETTINGS ROMDATA h8dgi_ap_mtrr_list[] =
{
...
#define BLDCFG_BUID_SWAP_LIST			&h8dgi_manual_swaplist
#define BLDCFG_HTFABRIC_LIMITS_LIST		&h8dgi_cpu2cpu_limit_list
#define BLDCFG_HTCHAIN_LIMITS_LIST		&h8dgi_io_limit_list
#define BLDCFG_PLATFORM_DEEMPHASIS_LIST		&h8dgi_deemphasis_list
#define BLDCFG_AP_MTRR_SETTINGS_LIST		&h8dgi_ap_mtrr_list
//#define BLDCFG_SYSTEM_PHYSICAL_SOCKET_MAP	&h8dgi_socket_map
